...
AAdventureCharacter::AAdventureCharacter()
{
	...
	//THIRD-PERSON MESH SETUP
		// First-Person Rendering pass should treat the third-person mesh as regular world geometry, even when hidden
	GetMesh()->FirstPersonPrimitiveType = EFirstPersonPrimitiveType::WorldSpaceRepresentation;


	//CAMERA SETUP
		// Attach the camera component to the character's head bone
